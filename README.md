...
The images are based on the current [Debian 13][docker-debian] and the previous [Debian 12][docker-debian] and [Debian 11][docker-debian] and they include [Xfce][xfce] desktop, [TigerVNC][tigervnc] server and [noVNC][novnc] client.
