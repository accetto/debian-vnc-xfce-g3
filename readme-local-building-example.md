...
./ci-builder.sh all-no-push group latest-firefox
```
...
```shell
docker build --target stage_xfce --no-cache -f ./docker/Dockerfile.xfce.12 ...
```
...
```shell
docker build --no-cache -f ./docker/Dockerfile.xfce.12 ...
```
